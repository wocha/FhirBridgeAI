...
def main() -> int:
    ...
    posture_result = _run_command(
        ...
        extra_env={
            "INTERNAL_AUTH_CONTEXT_SECRET": "demo-internal-auth-context-secret-replace-before-deploy",
            "MINIO_ROOT_USER": "miniooperator",
            "MINIO_ROOT_PASSWORD": "demo-minio-password-replace-before-deploy",
            "FHIR_SERVER_URL": "https://fhir.example.invalid/fhir",
            "FHIR_AUTH_BEARER": "demo-fhir-bearer-replace-before-deploy",
            "POSTGRES_USER": "pg_user_test",
            "POSTGRES_PASSWORD": "demo-postgres-password-replace-before-deploy",
            "POSTGRES_DB": "fhirbridge",
            "DATABASE_URL": "postgresql://pg_user_test:demo-postgres-password-replace-before-deploy@postgres:5432/fhirbridge?sslmode=require",
            "RABBITMQ_DEFAULT_USER": "mq_admin_test",
            "RABBITMQ_DEFAULT_PASS": "demo-rabbitmq-password-replace-before-deploy",
        },
    )
